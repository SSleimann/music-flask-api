...
class ArtistResource(Resource, ArtistFilter):
    ...
    def post(self):
        ...
        data_parser.add_argument(
            "description", required=True, help="Description is required!", type=str
        )
        data_parser.add_argument(
            "year_of_birth",
            type=str,
            required=True,
            help="Year of birth is required and the format must be: YYYY-MM-DD",
        )
